# -*- coding: utf-8 -*-
"""
Created on Mon Mar 25 15:50:13 2019
...
df_lga = pd.read_csv('LGA_weather-2018.csv')
df_jfk = pd.read_csv('JFK_weather-2018.csv')
df_phl = pd.read_csv('PHL_weather-2018.csv') 
df_sfo = pd.read_csv('SFO_weather-2018.csv') 

#Take only required columns from each dataset
#Sometimes while merging, index columns are created
df_bos = df_bos[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_den = df_den[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_dfw = df_dfw[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_ewr = df_ewr[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_iah = df_iah[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_ord = df_ord[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_lga = df_lga[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_jfk = df_jfk[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_phl = df_phl[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]
df_sfo = df_sfo[['CITY','FL_DATE','SurfaceTemperatureFarenheit','PrecipitationPreviousHourInches','CloudCoveragePercent',	
                 'SnowfallInches','WindSpeedKnots','FLY_date','FLY_hour']]

#join each dataframe
#make sure that column names must be same for each dataframe
aggr_dataset = [df_bos,df_den,df_dfw,df_ewr,df_iah,df_jfk,df_lga,df_ord,df_phl,df_sfo]
...
#save data to csv
finaldf.to_csv('2018weathercleaned.csv')
